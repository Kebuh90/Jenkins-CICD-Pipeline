...
pipeline {
    ...
    stage('SonarQube Scan') {
      steps {
        sh """mvn sonar:sonar \
              ...
              -Dsonar.host.url=http://172.31.39.127:9000 \
              -Dsonar.login=b6d818e5d7aa039b210963b7bcd4db37d03ba33d"""
      }
    }
  ...
  post {
    always {
        ...
        slackSend channel: 'marion-jenkins-cicd-pipelines-alerts ', //update and provide your channel name
